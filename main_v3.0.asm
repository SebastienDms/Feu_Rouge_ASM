;
; Feu rouge v2.1
;Changement de pin led unique sur PB
; Created: //20/05/2020
...
;Initialisation Port E ;PD0 = Led – PD1 à PD7 libres
	ldi r16, 0xff ;Port en sortie (les bits du port sont mis à 1, soit en sortie)
	out DDRE, r16 ;Ecriture sur le DDR
	sbi PORTE, 2
	;ser r16 ;Port en HIGH (les bits du port sont mis à 1)
	;out PORTE, r16 ;Port E mis à 1
...
;Allume rouge voit allumer vert piéton
ldi r17, 0b10000010
;eor r16, r17			;OU exclusive entre 16 et 17 stocké dans r16
out PORTB, r17
;éteindre orange piéton allumer vert piéton
;ldi r19, 0b00100000
;out PORTE, r19
...
L1: dec  r21
    ...
    brne L1
    rjmp PC+1
;éteindre rouge voit allumer orange piéton éteindre vert piéton
ldi r17, 0b00100001
out PORTB, r17
;éteindre vert piéton allume orange piéton
;ldi r19, 0b00010000
;out PORTE, r19
;allume vert
;ldi r16, 0b00100000
